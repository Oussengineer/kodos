...
export default function DriverLayout() {
  ...
  const nav = [
    { path: "/", label: t("driver.layout.available"), icon: "📋" },
    { path: "/active", label: t("driver.layout.active"), icon: "🚚", badge: activeCount },
    { path: "/history", label: t("driver.layout.history"), icon: "📦" },
  ];

  return (
    <div className="app-layout">
      <header className="driver-header">
        <span className="driver-greeting">{t("driver.layout.hey", { name: user?.name?.split(" ")[0] || "Driver" })}</span>
